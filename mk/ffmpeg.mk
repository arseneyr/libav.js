...
ffmpeg/build-base-mux-only/%.o: export ECFLAGS += -include libavutil/internal.h
ffmpeg/build-base-mux-only/%: \
	ffmpeg/build-base-mux-only/ffbuild/config.mak
	cd ffmpeg/build-base-mux-only ; emmake $(MAKE) $*
...
ffmpeg/build-base-%/ffbuild/config.mak: tmp-inst/base/cflags.txt configs/%/ffmpeg-config.txt
	test ! -e configs/$(*)/deps.txt || $(MAKE) `sed 's/@TARGET/base/g' configs/$(*)/deps.txt`
	mkdir -p ffmpeg/build-base-$(*) ; \
	cd ffmpeg/build-base-$(*) ; \
